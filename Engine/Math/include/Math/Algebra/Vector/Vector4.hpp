...
namespace NuEngine::Math
{
    ...
    public:
         ...
         * @param w Value on W.
         */
        NU_FORCEINLINE Vector4(NuFloat x, NuFloat y, NuFloat z, NuFloat w) noexcept
         ...
         */
        explicit NU_FORCEINLINE Vector4(const Vector3& vec, NuFloat w = 0.0f) noexcept; 
         ...
         * @return A new Vector4 that is the result of the conversion.
         */
        explicit NU_FORCEINLINE Vector4(const Vector2& vec, NuFloat z = 0.0f, NuFloat w = 0.0f) noexcept;
        ...
        */
         ...
         */
        [[nodiscard]] NU_FORCEINLINE Vector4 Min(Vector4 other) const noexcept
        {
         ...
         */
        [[nodiscard]] NU_FORCEINLINE Vector4 Max(Vector4 other) const noexcept
        {
         ...
         */
        [[nodiscard]] NU_FORCEINLINE NuBool operator==(Vector4 other) const noexcept
        {
         ...
         */
        [[nodiscard]] NU_FORCEINLINE NuBool NearEqual(Vector4 other, NuFloat epsilon) const noexcept
        {
        ...
        */
         ...
         */
        [[nodiscard]] NU_FORCEINLINE NuFloat Dot(Vector4 other) const noexcept
        {
         ...
         */
        [[nodiscard]] NU_FORCEINLINE NuFloat Distance(Vector4 other) const noexcept
        {
        ...
        /**
         * @brief Performs linear interpolation towards another 4D vector.
         *
...
namespace NuEngine::Math 
{
    explicit NU_FORCEINLINE Vector4::Vector4(const Vector3& vec, NuFloat w) noexcept
        : m_data(VectorAPI::Set(vec.X(), vec.Y(), vec.Z(), w))
    {
    }

    explicit NU_FORCEINLINE Vector4::Vector4(const Vector2& vec, NuFloat z, NuFloat w) noexcept
        : m_data(VectorAPI::Set(vec.X(), vec.Y(), z, w))
    {
    }
}