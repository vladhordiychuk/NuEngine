...
namespace NuEngine::Graphics::OpenGL
{
    ...
    */
    ...
    public:
        ...
        * 
        */
        [[nodiscard]] Core::Result<void, Core::GraphicsError> Initialize() noexcept override;

        /*
        * 
        */
        [[nodiscard]] Core::Result<void, Core::GraphicsError> SwapBuffers() noexcept override;

        /*
        * 
        */
        [[nodiscard]] Core::Result<void, Core::GraphicsError> MakeCurrent() noexcept override;
